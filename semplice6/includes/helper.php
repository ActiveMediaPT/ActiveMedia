		...
		<div id="studio-feature-' . $feature . '" class="popup studio-popup">
			...
			<div class="popup-inner feature-popup-inner">
				...
				<div class="popup-footer">
					' . $see_it_live . '
					<a href="https://transactions.sendowl.com/products/78691114/20846C22/add_to_cart" class="feature-purchase" target="_blank">Upgrade to Studio for $49</a>
				</div>					
			</div>
		</div>
	';
...
function semplice_whats_new_html($version) {
	...
	$seven = '
		<div class="feature">
			<p class="new-feature-heading"><span class="new-feature">New</span>The new S7 upgrade is finally here.</p>
			<p class="feature-desc">We rebuilt and redesigned Semplice from scratch on a more modular system, making it more flexible and future-proof than ever. S7 is our best version so far and we\'re proud to finally show it to you. You can find all <a href="https://www.semplice.com/v7" target="_blank">the new S7 features right here.</a> And as always, we offer a 20&percnt; family discount if you decide to upgrade. <a href="https://www.semplice.com/get-semplice#upgrade" target="_blank">You can upgrade here.</a><br><br>We hope you like it! And as always, this S7 upgrade is entirely optional, you are more than welcome to stay on your current version as well. If you have questions, you can get in touch with us via <a href="mailto:help@semplice.com">help@semplice.com</a>
			</p>
			<a href="https://www.semplice.com/v7" target="_blank"><img src="https://assets.semplice.com/whats-new/6-2-5\s7.jpg" alt="The new S7 upgrade is finally here."></a>
		</div>
	';
	// output
	$output = '
